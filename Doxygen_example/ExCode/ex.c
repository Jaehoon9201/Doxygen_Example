...
/// @param         f : Residual. 'f' recieves (int,int,double*,double*,int *) format inputs.
/// @param         m : Number of parameters
/// @param         n : Number of data
/// @param         x : Parameters of the model-based friction model.
/// @param         msk : 
/// @param         fvec : 'Dfferences' which are used for calculating magnitude of step-by-step optimization.
///                        --> The function evaluated at the output
/// @param         ftol :tolerance for checking the opimization process
/// @param         xtol : The calculation will terminate if the relative error between two
///                       consecutive iterates is at most `xtol`.
/// @param         gtol :tolerance for checking the opimization process
...
///                      of the jacobian.
/// @param         maxfev : The maximum number of calls to the function. If zero, then
///                         ``100*(N+1)`` is the maximum where N is the number of elements in `x0`.
/// @param         epsfcn : A suitable step length for the forward-difference
///                         approximation of the Jacobian (for ``fprime=None``). If
///                         `eps` is less than the machine precision, it is assumed
///                         that the relative errors in the functions are of the order of
///                         the machine precision.
/// @param         diag : 1-->  diag is internally set, 2-->contain positive entries that serve as 
///                       multiplicative scale factors for the variables. 100 is a generally recommended value
/// @param         factor : determining the  initial step bound.
/// @param         info : It is offered from MINPACK algorithm. It alarms a process condition.
/// @param         nfev : the number of calls to fcn.
/// @param         fjac : Final calculated jacobian.
/// @param         ipvt : it defines a permutation matrix p such that jac*p = q*r
/// @param         qtf :  it contains the first n elements of the vector (q transpose)*fvec.
/// @param         wa1 : Work arrays
/// @param         wa2 : Work arrays
/// @param         wa3 : Work arrays
/// @param         wa4 : : Work arrays
/// @return 	  otuputs
/// @note ----
